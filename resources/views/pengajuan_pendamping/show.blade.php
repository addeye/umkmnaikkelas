                            ...
                            <div class="panel-action">
                                <ul class="panel-actions">
                                    <li>
                                        ...
                                        <form id="delete-formdata-{{$pengajuan->id}}" action="{{route('penghargaan-pendamping.destroy',['id'=>$pengajuan->id])}}" method="POST" style="display: none;">{{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{route('penghargaan-pendamping.getfile',['path'=>$file->path])}}"><span class="icon wb-file"></span> {{$file->nama}}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
