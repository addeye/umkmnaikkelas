            ...
            @foreach($data as $row)
              <tr>
                ...
                <td class="text-nowrap">
                  <a href="{{route('penghargaan-umkm.show',['id'=>$row->id])}}" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip" data-original-title="Show"><i class="icon wb-eye" aria-hidden="true"></i></a>
                </td>
              </tr>
            @endforeach
            </tbody>
