...
<html>
<head>
<title>Pendaftar Baru | umkmnaikkelas.com</title>
<!-- Custom Theme files -->
						...
						<td>
							<table class="ban-hei" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="background:url({{asset('images/box/test.jpg')}}); background-size:cover;">	
								<tbody>
														...
														<td>				
															<table class="ban_info" border="0" cellpadding="0" cellspacing="0"  width="500">				
																<tbody>
																	...
																	<tr>
																		<td class="future" style="font-size:2.3em;color:#020202;text-transform:capitalize;font-family:Candara;text-align:center;line-height:1.5em">
																		Terimakasih<br>
																		{{$data->name}}
																		</td>
																	</tr>	
									...
									<tr>
										<td style="font-size:1.3em;color:#d9534f;font-family:Candara;text-align:center">
											#umkmnaikkelas | #lunas
										</td>
									</tr>
									<tr>
										...
										<td>
											<table class="twelve_four" width="100" align="left" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
												<tbody>
													<tr>
														<td align="center">
															<img src="{{asset('images/box/pelaksana-mitra.jpg')}}" alt=" " width="200" height="200" class="full team_img">
														</td>
													</tr>
												</tbody>
											</table>
												...
												<tbody>
													...
													<tr>
														<td class="ser_text text_team" align="left" style="color: #464646;font-size: 1.2em;font-family: Candara;line-height: 1.8em;">
															Halaman form registrasi sebagai pendamping
														</td>
													</tr>
													<tr>
														<td height="10"></td>
													...
													<tr>
														<td class="text_team" align="left" style="color: #d70b03;font-size: 1.2em;font-family: Candara;line-height: 1.8em;">
															 <a href="{{route('daftar.pendamping')}}">Klik disini</a>
														</td>
													</tr>
												</tbody>
											</table>	
										...
										<td>
												...
												<tbody>
													...
													<tr>
														<td class="ser_text text_team" align="right" style="color: #464646;font-size: 1.2em;font-family: Candara;line-height: 1.8em;">
															Halaman form registrasi sebagai UMKM
														</td>
													</tr>
													<tr>
														<td height="10"></td>
													...
													<tr>
														<td class="text_team" align="right" style="color: #d70b03;font-size: 1.2em;font-family: Candara;line-height: 1.8em;">
															 <a href="{{route('daftar.umkm')}}">Klik disini</a>
														</td>
													</tr>
												</tbody>
											</table>
											...
											<table class="twelve_four" width="100" align="right" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
												<tbody>
													<tr>
														<td align="center">
															<img src="{{asset('images/box/pendampingan.jpg')}}" alt=" " width="200" height="200" class="full team_img">
														</td>
													</tr>
												</tbody>
											</table>									
						...
						<td>
							<table border="0" width="100%" align="center" cellpadding="0" cellspacing="0" class="container-middle">
								<tbody>
									...
									@foreach($info as $row)
									<tr>
										<td class="ser_text" align="left" style="color:#464646; font-size: 1.2em; font-family: Candara; line-height:1.8em;padding: 10px;">
											...
											<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
												...
												<tr>
													<td class="ser_text" align="center" style="font-size:1.1em;color:#464646;line-height:1.8em;font-family:Candara;">
														<img class="img-responsive" src="{{ $message->embed($pathToFile) }}">
													</td>
												</tr>
												<tr>
													<td align="center" style="font-size:1.2em;color:#d70b03;font-family:Candara;">PROSEDUR PENDAMPING NAIK KELAS</td>
												</tr>
												<tr>
													<td>&nbsp;</td>
												</tr>
											...
											<table class="foo" width="375" border="0" align="left" cellpadding="0" cellspacing="0">
												<tr>
													<td class="ser_text editable"style="font-family: Candara; font-size: 1em; color: #ffffff; line-height: 24px;">
														© 2017 Peac Bromo . All Rights Reserved | Design by <a href="#" style="color: #fff; font-size: 1em;text-decoration:none;"> W3layouts</a>
													</td>
												</tr>
											</table>
											...
											<table class="foo1" width="170" border="0" align="right" cellpadding="0" cellspacing="0">
												<tr>
													<td class="ser_text editable" style="font-family: Candara; font-size: 1em; color: #ffffff; line-height: 24px;">
														...
														<a target="_blank" href="http://umkmnaikkelas.com" style="color:#ffffff;text-decoration:none;" data-size="Footer Text" data-color="Footer Text">
