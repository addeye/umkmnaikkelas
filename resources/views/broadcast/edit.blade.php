        ...
        <div class="col-md-12">
          ...
          <div class="panel">
            ...
            <div class="panel-body">
              <form class="form-horizontal" method="post" action="{{route('broadcast.update',['id'=>$data->id])}}">
                <input type="hidden" name="_method" value="PUT">
                {{ csrf_field()}}
                <div class="form-group {{ $errors->has('subject') ? ' has-error' : '' }}">
                  <label class="col-sm-3 control-label">Subject*</label>
                  <div class="col-sm-9">
                    <input type="text" name="subject" class="form-control" value="{{$data->subject}}" placeholder="subject email" required>
                ...
                <div class="text-right">
                  ...
                  <a href="{{route('broadcast.show',['id'=>$data->id])}}" class="btn btn-warning">Cancel</a>
                </div>
              </form>
            </div>
          </div>
