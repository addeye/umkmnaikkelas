      ...
      <div class="panel">
        ...
        <div class="panel-body">
            ...
            @foreach($data as $row)
              <tr>
                ...
                <td class="text-nowrap">
                  <a href="{{route('slider.edit',['id'=>$row->id])}}" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-wrench" aria-hidden="true"></i></a>
                  ...
                  <form id="delete-form-{{$row->id}}" action="{{route('slider.destroy',['id'=>$row->id])}}" method="POST" style="display: none;">{{ csrf_field() }}
          ...
          <div class="floating" data-toggle="tooltip" data-placement="left" title="" data-original-title="Tambah Data">
                <a href="{{url('slider/create')}}"><i class="icon wb-plus" aria-hidden="true"></i></a>
            </div>
        </div>
      </div>      
      <!-- End Panel Basic -->
