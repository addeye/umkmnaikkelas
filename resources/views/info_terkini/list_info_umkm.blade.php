    ...
    <div class="page-content">
      ...
      <div class="panel">
        <header class="panel-heading">
          ...
          <h3 class="panel-title">Info UMKM</h3>
        </header>
        <div class="panel-body">
            ...
            @foreach($data as $row)
              <tr>
                ...
                <td class="text-nowrap">
                  <a href="{{route('info.umkm.edit',['id'=>$row->id])}}" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-wrench" aria-hidden="true"></i></a>
          ...
          <div class="floating" data-toggle="tooltip" data-placement="left" title="" data-original-title="Tambah Data">
                <a href="{{url('info-umkm/create')}}"><i class="icon wb-plus" aria-hidden="true"></i></a>
            </div>
        </div>
      </div>
      <!-- End Panel Basic -->
