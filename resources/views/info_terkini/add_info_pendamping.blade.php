        ...
        <div class="col-md-12">
          ...
          <div class="panel">
            <div class="panel-heading">
              <h3 class="panel-title"><i class="con wb-plus"></i> Tambah Info Pendamping</h3>
            </div>
            <div class="panel-body">
              <form class="form-horizontal" method="post" action="{{route('info-terkini.store')}}">
                {{ csrf_field()}}
                <input type="hidden" name="user_id" value="{{Auth::user()->id}}">
                <input type="hidden" name="level" value="Pendamping">
                ...
                <div class="text-right">
                  ...
                  <a href="{{route('info.pendamping')}}" class="btn btn-warning">Cancel</a>
                </div>
              </form>
            </div>
          </div>
